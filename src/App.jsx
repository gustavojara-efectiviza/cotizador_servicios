...
import CRMFinancialPanel from './CRMFinancialPanel';
    ...
    <div className="app-container">
      ...
      <header className="header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          >
            <DatabaseIcon size={18} /> Mis Cotizaciones
          </button>
          <button 
        ...
        <div className="left-panel" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
          ...
          <div className="odoo-card" style={{ borderLeft: '4px solid #2563eb' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
              ...
              <button className="primary-btn" onClick={handleSaveCotizacion} style={{ width: 'auto', padding: '8px 16px' }}>
